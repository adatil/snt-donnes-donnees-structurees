...
\textcolor{blue}{\textbf{Réponse :}} Il s'agit du film \textbf{« UN P'TIT TRUC EN PLUS »} avec 10,72 millions d'entrées (10~716~771 entrées exactement).

\vspace{0.5cm}
\textbf{Question 2 :} Quel est le film français ayant fait le plus d'entrées en 2023 ?

\textcolor{blue}{\textbf{Réponse :}} En 2023, le film français ayant réalisé le plus d'entrées est \textbf{« ASTÉRIX ET OBÉLIX ET L'EMPIRE DU MILIEU »} avec 4,61 millions d'entrées (4~605~168 entrées).

\vspace{0.5cm}
\textbf{Question 3 :} Quelle est la nationalité du film ayant fait le plus d'entrées en 2023 ?

\textcolor{blue}{\textbf{Réponse :}} Le film ayant réalisé le plus d'entrées en 2023 est « SUPER MARIO BROS. LE FILM » qui est un film \textbf{américain (US)} avec 7,25 millions d'entrées.
...
\textit{Démarche :} Onglet 2024, appliquer un AutoFiltre sur la ligne 7, filtrer la nationalité en ne gardant que « FRANCE », observer les premières lignes.
...
\textit{Démarche :} Avec le filtre français actif, utiliser \texttt{=SOUS.TOTAL(3;B8:B49)} pour compter le nombre de lignes filtrées.
...
\textit{Démarche :} Avec le filtre français actif, utiliser \texttt{=SOUS.TOTAL(9;E8:E49)} pour sommer les entrées.
...
\textit{Démarche :} Avec les filtres de la question précédente, utiliser \texttt{=SOUS.TOTAL(9;E8:E49)}.
...
\textcolor{blue}{\textbf{Réponse :}} Le film français avec le moins d'entrées est \textbf{« EMILIA PEREZ »} avec 1,08 million d'entrées (1~083~748 entrées).
...
\textit{Démarche :} Onglet 2023, AutoFiltre, filtrer sur FRANCE, utiliser \texttt{=SOUS.TOTAL(3;B8:B49)}.
...
\textcolor{blue}{\textbf{Réponse :}} Le film américain ayant réalisé le plus d'entrées en 2023 est \textbf{« SUPER MARIO BROS. LE FILM »} avec \textbf{7,25 millions d'entrées} (7~249~542 entrées).
...
\textcolor{blue}{\textbf{Réponse :}} Il s'agit du film \textbf{« LE GARÇON ET LE HÉRON »} avec 1,55 million d'entrées.
...
L'année \textbf{2023} a connu plus de succès en termes de nombre de films à succès. Cependant, en 2024, le film « UN P'TIT TRUC EN PLUS » a réalisé un record avec 10,72 millions d'entrées, soit plus que le meilleur film de 2023 (7,25 millions).
...
\textcolor{blue}{\textbf{Réponse :}} Le film français ayant réalisé le plus d'entrées est \textbf{« UN P'TIT TRUC EN PLUS »} sorti en \textbf{2024} avec \textbf{10,72 millions d'entrées}.
...
\textbf{Question 18 :} Téléchargez le fichier \textit{Liste des établissements cinématographiques actifs} sur data.gouv.fr. Combien de cinémas « Art et Essai » sont équipés d'un écran 3D ?

\textcolor{blue}{\textbf{Réponse :}} \textbf{728 cinémas} « Art et Essai » sont équipés d'un écran 3D.

\textit{Démarche :} Télécharger le fichier, ouvrir avec LibreOffice Calc, appliquer deux filtres simultanément (Art et Essai = OUI, Écran 3D = OUI), utiliser \texttt{=SOUS.TOTAL(3;...)} pour compter les lignes.
